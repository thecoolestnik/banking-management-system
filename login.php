...
<body style="background: url(images/bg-l2.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 22pt;"><kbd>PRESENTED BY NIKHIL DUSSA</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
