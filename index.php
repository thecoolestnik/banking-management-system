...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/lg.png" width="30" height="30" class="d-inline-block align-top" alt="">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to ND BANK </h4>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/bank.jpg" alt="First slide" style="max-height: 375px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/bankqueue.jpg" alt="Second slide" style="max-height: 375px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/logotsf.png" alt="Third slide" style="max-height: 375px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/manquery.jpg" alt="Fourth slide" style="max-height: 375px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/mirage.jpg" alt="Fifth slide" style="max-height: 375px">
          </div>
